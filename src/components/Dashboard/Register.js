    ...
    //     console.log("e",e);
        useEffect(() => {
            if(check){
                ...
                axios.post(API_BASE_URL+'/API/team/create/',input,{
                        headers: {
        ...
        <div className="registerContainer">
            ...
            <div className="registerForm">
                ...
                <Form className="form">
                    ...
                    {firstmember && <FormGroup>
                        <Input
                            type="email"
                            name="leader"
                            value={input.leader}
                            valid={input.leader !== '' && isEmail(input.leader)}
                            invalid={
                    ...
                    {secondmember &&<FormGroup>
                        <Input
                            type="email"
                            name="member1"
                            value={input.member1}
                            valid={input.member1 !== '' && isEmail(input.member1)}
                            invalid={
                                input.member1 !== '' && !isEmail(input.member1)
                            }
                            onChange={(e) => {
                                inputChangeHandler(e)
                            }}
                    ...
                    {thirdmember && <FormGroup>
                        <Input
                            type="email"
                            name="member2"
                            value={input.member2}
                            valid={input.member2 !== '' && isEmail(input.member2)}
                            invalid={
                                input.member2 !== '' && !isEmail(input.member2)
                            }
                            onChange={(e) => {
                                inputChangeHandler(e)
                            }}
