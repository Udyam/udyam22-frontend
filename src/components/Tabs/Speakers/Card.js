...
function Card(props) {
    ...
    return (
        ...
        >
            ...
            <div >
            <a href={props.instagram} style={{ display: isHovering , position: "relative" , right: "80px"}}>
                <img src= {linkedin_logo} />
            </a>
            <a href={props.twitter} style={{ display: isHovering , position: "relative" ,bottom: "60px" }}>
                <img src= {twitter_logo} />
            </a>
            <a href={props.facebook} style={{ display: isHovering , position: "relative" , left: "80px" , bottom: "120px"}}>
